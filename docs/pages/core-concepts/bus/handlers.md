...
Hassette supports four handler patterns: no parameters, raw events, typed
events, and extracted data via dependency injection.
...
classes for each Home Assistant domain.
...
The [Dependency Injection](dependency-injection.md) page covers the full
