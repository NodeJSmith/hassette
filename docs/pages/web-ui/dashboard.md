...
Below the App Health grid, the **System Health** section shows framework-level errors — issues within Hassette itself rather than in your automations. Click the section header to expand it and see recent framework errors. A badge shows the total framework error count; green means none.

## Recent Errors

The **Recent Errors** section lists the most recent handler and job errors from your apps. Each entry displays:
