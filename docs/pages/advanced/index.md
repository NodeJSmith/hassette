...
The `TypeRegistry` allows you to manually register new type converters, giving you full control over how custom types are handled in your automations. You can also access the registry directly if needed, which allows you to convert between types without having to rewrite your type conversion logic.
