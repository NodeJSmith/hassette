...
- `create_component_loaded_event` builds a `ComponentLoadedEvent` for a given component name.
- `create_service_registered_event` builds a `ServiceRegisteredEvent` for a given domain and service.
