...
it's own [AppDaemon comparison page](https://github.com/custom-components/pyscript/wiki/Comparing-Pyscript-to-AppDaemon), which is worth a read.
...
- [AppDaemon Comparison](appdaemon.md)
