...
You don't need to do anything else at this point - Hassette automatically discovers apps in the specified app directory (or it's children) (this is configurable via :attr:`HassetteConfig.auto_detect_apps <hassette.config.core_config.HassetteConfig.auto_detect_apps>`).
