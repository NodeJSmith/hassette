...
def make_executor(*, error_handler_timeout: float = 5.0) -> CommandExecutor:
    ...
    hassette.config.lifecycle.command_executor_capacity_warn_threshold = 0.75
    hassette.config.lifecycle.command_executor_capacity_warn_rate_limit_seconds = 30.0
