...
def test_deserialize_missing_class_returns_sentinel() -> None:
    """Unpickling a class that no longer exists returns the failure sentinel."""
...
def test_deserialize_garbage_bytes_returns_sentinel() -> None:
    """Unpickling garbage bytes returns the failure sentinel."""
