...
def make_listener(*, timeout: float | None = None, timeout_disabled: bool = False) -> Listener:
...
class TestListenerTimeout:
    def test_listener_create_with_timeout(self) -> None:
        ...
        listener = make_listener(timeout=5.0)
    ...
    def test_listener_create_timeout_disabled(self) -> None:
        ...
        listener = make_listener(timeout_disabled=True)
    ...
    def test_listener_timeout_disabled_in_equality(self) -> None:
        ...
        listener_a = make_listener(timeout_disabled=False)
        listener_b = make_listener(timeout_disabled=True)
        assert listener_a != listener_b
