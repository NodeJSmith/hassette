...
* **ui:** add roving tabindex to interactive tables ([#1190](https://github.com/NodeJSmith/hassette/issues/1190)) ([97a70de](https://github.com/NodeJSmith/hassette/commit/97a70deb78ece5a9713d049ca20523a10f295378)), closes [#750](https://github.com/NodeJSmith/hassette/issues/750)
* update typed state models for HA 2026.7 and sweep dependency dashboard ([#1197](https://github.com/NodeJSmith/hassette/issues/1197)) ([46359de](https://github.com/NodeJSmith/hassette/commit/46359dedc6cbc83e8799bd1340433cbcc4047279)), closes [#1161](https://github.com/NodeJSmith/hassette/issues/1161)


### Bug Fixes

* eliminate CI warnings from atexit races, blocking-I/O guard, and httpx deprecation ([#1176](https://github.com/NodeJSmith/hassette/issues/1176)) ([47d60e4](https://github.com/NodeJSmith/hassette/commit/47d60e4b56a076a1ac9ac9fe3673358f07cdcb6b))
* entity turn_on/off/toggle use homeassistant domain ([#1205](https://github.com/NodeJSmith/hassette/issues/1205)) ([9dbb403](https://github.com/NodeJSmith/hassette/commit/9dbb4032d3ff7467191f981cd18e110613db8d06)), closes [#1021](https://github.com/NodeJSmith/hassette/issues/1021)
* harden bus predicate handling and async callable detection ([#1257](https://github.com/NodeJSmith/hassette/issues/1257)) ([9d655d2](https://github.com/NodeJSmith/hassette/commit/9d655d22030c757148e8f38cebbfdc8d89e15a0a)), closes [#1243](https://github.com/NodeJSmith/hassette/issues/1243) [#1244](https://github.com/NodeJSmith/hassette/issues/1244)
* harden SyncExecutorService restart and concurrency edge cases ([#1263](https://github.com/NodeJSmith/hassette/issues/1263)) ([1533a56](https://github.com/NodeJSmith/hassette/commit/1533a565cec3be920bb8f0b89466998ec2372fb6)), closes [#1225](https://github.com/NodeJSmith/hassette/issues/1225) [#1226](https://github.com/NodeJSmith/hassette/issues/1226)
* leaked app listeners/jobs and websocket subscribe double-fire on retry ([#1264](https://github.com/NodeJSmith/hassette/issues/1264)) ([1269eb8](https://github.com/NodeJSmith/hassette/commit/1269eb826c60e4d6f57204b8eebb6cbd1d276ab7)), closes [#1220](https://github.com/NodeJSmith/hassette/issues/1220) [#1221](https://github.com/NodeJSmith/hassette/issues/1221)
...
* normalize codegen enum names to canonical convention ([#1201](https://github.com/NodeJSmith/hassette/issues/1201)) ([7f507c7](https://github.com/NodeJSmith/hassette/commit/7f507c7bdb4d94a42444956b50773ada9a0a491a)), closes [#1199](https://github.com/NodeJSmith/hassette/issues/1199)
* propagate contextvars to worker threads in run_in_thread ([#1172](https://github.com/NodeJSmith/hassette/issues/1172)) ([c414353](https://github.com/NodeJSmith/hassette/commit/c414353fdb695c43c88a8e696b3860eb67747f0a)), closes [#1145](https://github.com/NodeJSmith/hassette/issues/1145)
* use MagicMock for invoke_error_handler in predicate failure test ([#1268](https://github.com/NodeJSmith/hassette/issues/1268)) ([7700efc](https://github.com/NodeJSmith/hassette/commit/7700efc5e7f927269e2e5f907a183833fdfeb4b6))


### Performance Improvements

* collect coverage on Python 3.14 only in CI ([#1213](https://github.com/NodeJSmith/hassette/issues/1213)) ([3fd3b66](https://github.com/NodeJSmith/hassette/commit/3fd3b6609c1de719f5ded7e02e49f11f18c4cd0f))
* improve logs page under live updates ([#1254](https://github.com/NodeJSmith/hassette/issues/1254)) ([d5b3fd3](https://github.com/NodeJSmith/hassette/commit/d5b3fd36a393da8dc8fd6162e3b2e4b3402fcc85))


### Refactoring

* clean up code quality findings across backend and frontend ([#1266](https://github.com/NodeJSmith/hassette/issues/1266)) ([2f77747](https://github.com/NodeJSmith/hassette/commit/2f777479e9e7efea519e56442e31cf16e379b9c3)), closes [#1209](https://github.com/NodeJSmith/hassette/issues/1209) [#1210](https://github.com/NodeJSmith/hassette/issues/1210) [#1214](https://github.com/NodeJSmith/hassette/issues/1214) [#1215](https://github.com/NodeJSmith/hassette/issues/1215) [#1217](https://github.com/NodeJSmith/hassette/issues/1217) [#1218](https://github.com/NodeJSmith/hassette/issues/1218) [#1219](https://github.com/NodeJSmith/hassette/issues/1219) [#1256](https://github.com/NodeJSmith/hassette/issues/1256) [#1260](https://github.com/NodeJSmith/hassette/issues/1260) [#1262](https://github.com/NodeJSmith/hassette/issues/1262) [#1265](https://github.com/NodeJSmith/hassette/issues/1265)
* clean up ServiceWatcher long methods, duplication, and test boilerplate ([#1267](https://github.com/NodeJSmith/hassette/issues/1267)) ([632ae93](https://github.com/NodeJSmith/hassette/commit/632ae93e8816eaf5fdafd2d4964e8d8a59928892)), closes [#1261](https://github.com/NodeJSmith/hassette/issues/1261)
* inject HA event operations into bus kernel via DI ([#1178](https://github.com/NodeJSmith/hassette/issues/1178)) ([1ea75b2](https://github.com/NodeJSmith/hassette/commit/1ea75b2d0d8b90f5dafb70ce40c21f9d97eecd4e)), closes [#1136](https://github.com/NodeJSmith/hassette/issues/1136)
* replace SYNC_WORKER_CELL list-cell with named SyncWorkerHandle ([#1180](https://github.com/NodeJSmith/hassette/issues/1180)) ([4e0f510](https://github.com/NodeJSmith/hassette/commit/4e0f51016aa535346acde819889317bde7c11f0a)), closes [#1170](https://github.com/NodeJSmith/hassette/issues/1170)
* strengthen API type safety, dedupe lint and schema tooling ([#1207](https://github.com/NodeJSmith/hassette/issues/1207)) ([6ff1b42](https://github.com/NodeJSmith/hassette/commit/6ff1b42cb23bf4a40748c4af754e21abe0642818)), closes [#1043](https://github.com/NodeJSmith/hassette/issues/1043) [#1056](https://github.com/NodeJSmith/hassette/issues/1056) [#1081](https://github.com/NodeJSmith/hassette/issues/1081) [#1083](https://github.com/NodeJSmith/hassette/issues/1083) [#1146](https://github.com/NodeJSmith/hassette/issues/1146) [#1185](https://github.com/NodeJSmith/hassette/issues/1185) [#1191](https://github.com/NodeJSmith/hassette/issues/1191) [#1200](https://github.com/NodeJSmith/hassette/issues/1200) [#1203](https://github.com/NodeJSmith/hassette/issues/1203) [#1204](https://github.com/NodeJSmith/hassette/issues/1204) [#1206](https://github.com/NodeJSmith/hassette/issues/1206)
* **ui:** clean up pre-existing style debt in table/grid and config components ([#1196](https://github.com/NodeJSmith/hassette/issues/1196)) ([f2b0f4f](https://github.com/NodeJSmith/hassette/commit/f2b0f4ff15635ed58359ace12925ad928c926a95))
