...
## [0.30.2](https://github.com/NodeJSmith/hassette/compare/v0.30.0...v0.30.2) (2026-05-19)

### Bug Fixes

- Include SPA frontend assets in PyPI package — the publish workflow was not building the frontend before packaging, so `pip install hassette` shipped without the web UI ([#788](https://github.com/NodeJSmith/hassette/issues/788))
