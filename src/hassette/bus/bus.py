...
class Bus(Resource):
    ...
    async def _on_internal(
        ...
        *,
        ...
        # Tier-aware default (see resolve_execution_mode): framework listeners default to
        # ``parallel`` to preserve supervisor/state-cache concurrency; app listeners default to
        # ``single``.
