...
class RecordingHelperClientSyncFacade:  # pyright: ignore[reportUnusedClass]
    ...
    def list(self, domain: HelperDomain) -> list[Any]:
        raise NotImplementedError(STUB_MSG_GENERIC.format(name="list"))

    def create(self, params: BaseModel) -> BaseModel:
        raise NotImplementedError(STUB_MSG_GENERIC.format(name="create"))

    def update(self, helper_id: str, params: BaseModel) -> BaseModel:
        raise NotImplementedError(STUB_MSG_GENERIC.format(name="update"))

    def delete(self, domain: HelperDomain, helper_id: str) -> None:
        raise NotImplementedError(STUB_MSG_GENERIC.format(name="delete"))

    def increment(self, entity_id: str) -> None:
        raise NotImplementedError(STUB_MSG_GENERIC.format(name="increment"))

    def decrement(self, entity_id: str) -> None:
        raise NotImplementedError(STUB_MSG_GENERIC.format(name="decrement"))

    def reset(self, entity_id: str) -> None:
        raise NotImplementedError(STUB_MSG_GENERIC.format(name="reset"))
