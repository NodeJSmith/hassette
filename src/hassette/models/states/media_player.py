...
class MediaPlayerAttributes(AttributesBase):
    ...
    media_content_type: MediaType | str | None = Field(default=None, union_mode="left_to_right")
    media_duration: int | float | None = Field(default=None)
    ...
    media_position: int | float | None = Field(default=None)
    ...
    repeat: RepeatMode | str | None = Field(default=None, union_mode="left_to_right")
