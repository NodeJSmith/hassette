...
class VacuumAttributes(AttributesBase):
    ...
    def supports_turn_on(self) -> bool:
        return self._has_feature(VacuumEntityFeature.TURN_ON)

    @property
    def supports_turn_off(self) -> bool:
        return self._has_feature(VacuumEntityFeature.TURN_OFF)
    ...
    def supports_battery(self) -> bool:
        return self._has_feature(VacuumEntityFeature.BATTERY)

    @property
    def supports_status(self) -> bool:
        return self._has_feature(VacuumEntityFeature.STATUS)
    ...
    def supports_map(self) -> bool:
        return self._has_feature(VacuumEntityFeature.MAP)

    @property
    def supports_state(self) -> bool:
        return self._has_feature(VacuumEntityFeature.STATE)
