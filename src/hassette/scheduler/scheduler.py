...
class Scheduler(Resource):
    ...
    def schedule(
        ...
        *,
        ...
        # Resolve instance_name once at registration (mirrors Bus._subscribe) so the executor hot path
        # reads it off the command instead of traversing app_handler per execution.
