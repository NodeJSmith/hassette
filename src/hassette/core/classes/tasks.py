...
def make_task_factory(bucket: TaskBucket) -> Callable[[asyncio.AbstractEventLoop, CoroLikeT], asyncio.Future]:
    def factory(_loop: asyncio.AbstractEventLoop, coro: CoroLikeT) -> asyncio.Task:
        ...
        t: asyncio.Task = asyncio.Task(coro, loop=_loop)
