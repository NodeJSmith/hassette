...
class OfficeButtonApp(AppSync[OfficeButtonAppConfig]):
    ...
    def on_initialize_sync(self) -> None:
        ...
        self.bus.on_call_service(
            ...
            where=P.ServiceDataWhere.from_kwargs(entity_id=C.IsOrContains(self.app_config.office_light)),
        )
        ...
        for entity_id in self.get_office_light().attributes.entity_id:  # pyright: ignore[reportAttributeAccessIssue]
