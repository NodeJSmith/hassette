...
It is generated from `bus.Bus` by `codegen/src/hassette_codegen/sync_facade.py`.
"""
...
It is generated from `scheduler.Scheduler` by `codegen/src/hassette_codegen/sync_facade.py`.
"""
