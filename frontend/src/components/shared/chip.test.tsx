...
describe("Chip", () => {
  describe("renders as span", () => {
    it("renders a <span> element", () => {
      const { getByTestId } = render(
        <Chip variant="modifier" data-testid="c">text</Chip>
      );
  ...
  describe("variant prop", () => {
    it("applies modifier class when variant='modifier'", () => {
      const { getByTestId } = render(
        <Chip variant="modifier" data-testid="c">mod</Chip>
      );
    ...
    it("applies schedule class when variant='schedule'", () => {
      const { getByTestId } = render(
        <Chip variant="schedule" data-testid="c">sched</Chip>
      );
    ...
    it("applies kind base class when variant='kind'", () => {
      const { getByTestId } = render(
        <Chip variant="kind" kind="ok" data-testid="c">ok</Chip>
      );
    ...
    it("applies origin class when variant='origin'", () => {
      const { getByTestId } = render(
        <Chip variant="origin" data-testid="c">origin</Chip>
      );
    ...
    it("applies muted class when variant='muted'", () => {
      const { getByTestId } = render(
        <Chip variant="muted" data-testid="c">muted</Chip>
      );
  ...
  describe("kind prop (when variant='kind')", () => {
    ...
    it("applies kindWarn class when kind='warn'", () => {
      const { getByTestId } = render(
        <Chip variant="kind" kind="warn" data-testid="c">warn</Chip>
      );
    ...
    it("applies kindErr class when kind='err'", () => {
      const { getByTestId } = render(
        <Chip variant="kind" kind="err" data-testid="c">err</Chip>
      );
    ...
    it("applies kindMute class when kind='mute'", () => {
      const { getByTestId } = render(
        <Chip variant="kind" kind="mute" data-testid="c">mute</Chip>
      );
    ...
    it("does NOT auto-render StatusShape — callers pass children", () => {
      const { getByTestId } = render(
        <Chip variant="kind" kind="ok" data-testid="c">ok label</Chip>
      );
  ...
  describe("size prop", () => {
    it("applies no size class when size is 'default'", () => {
      const { getByTestId } = render(
        <Chip variant="modifier" size="default" data-testid="c">mod</Chip>
      );
    ...
    it("applies sm class when size='sm'", () => {
      const { getByTestId } = render(
        <Chip variant="modifier" size="sm" data-testid="c">mod</Chip>
      );
  ...
  describe("class prop", () => {
    it("merges additional class into span className", () => {
      const { getByTestId } = render(
        <Chip variant="muted" class="extra-class" data-testid="c">text</Chip>
      );
  ...
  describe("aria-label pass-through", () => {
    it("passes aria-label through to the root span", () => {
      const { getByLabelText } = render(
        <Chip variant="origin" aria-label="origin: event">EVENT</Chip>
      );
  ...
  describe("children", () => {
    it("renders text children", () => {
      const { getByTestId } = render(
        <Chip variant="modifier" data-testid="c">hello</Chip>
      );
  ...
  describe("no duplicate auto variant", () => {
    it("does not have an auto class (merged into muted)", () => {
      ...
      const { getByTestId } = render(
        <Chip variant="muted" data-testid="c">text</Chip>
      );
