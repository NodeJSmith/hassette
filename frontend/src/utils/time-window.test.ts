...
describe("resolveSince", () => {
  ...
  it("returns Date.now()/1000 - uptimeSeconds for since-restart", () => {
    ...
    expect(result).toBe(BASE_TIMESTAMP_SECONDS - uptimeSeconds);
  });
